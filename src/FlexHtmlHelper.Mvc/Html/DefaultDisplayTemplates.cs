...
namespace FlexHtmlHelper.Html
{
    internal static class DefaultDisplayTemplates
    {
        ...
        internal static string EmailAddressTemplate(FlexHtmlHelper html)
        {
        ...
        internal static string HtmlTemplate(FlexHtmlHelper html)
        {
        ...
        internal static string UrlTemplate(FlexHtmlHelper html)
        {
            return String.Format(CultureInfo.InvariantCulture,
                                 "<a href=\"{0}\">{1}</a>",
                                 html.AttributeEncode(html.ViewContext.ViewData.Model),
