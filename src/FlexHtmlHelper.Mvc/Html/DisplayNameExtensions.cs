...
namespace FlexHtmlHelper.Html
{
    ...
    {
        public static MvcHtmlString DisplayName(this FlexHtmlHelper html, string expression)
        {
            return DisplayNameInternal(html, expression, metadataProvider: null);
        }

        internal static MvcHtmlString DisplayNameInternal(this FlexHtmlHelper html, string expression, ModelMetadataProvider metadataProvider)
        {
        ...
        public static MvcHtmlString DisplayNameForModel(this FlexHtmlHelper html)
        {
