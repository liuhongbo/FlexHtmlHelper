...
namespace FlexHtmlHelper.Html
{
    public static class RenderPartialExtensions
    {
        ...
        public static void RenderPartial(this FlexHtmlHelper htmlHelper, string partialViewName)
        {
        ...
        public static void RenderPartial(this FlexHtmlHelper htmlHelper, string partialViewName, ViewDataDictionary viewData)
        {
        ...
        public static void RenderPartial(this FlexHtmlHelper htmlHelper, string partialViewName, object model)
        {
        ...
        public static void RenderPartial(this FlexHtmlHelper htmlHelper, string partialViewName, object model, ViewDataDictionary viewData)
        {
