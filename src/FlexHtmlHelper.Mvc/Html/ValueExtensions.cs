...
namespace FlexHtmlHelper.Html
{
    ...
    {
        public static MvcHtmlString Value(this FlexHtmlHelper html, string name)
        {
            return Value(html, name, format: null);
        }

        public static MvcHtmlString Value(this FlexHtmlHelper html, string name, string format)
        {
            if (name == null)
            {
        ...
        public static MvcHtmlString ValueForModel(this FlexHtmlHelper html)
        {
            return ValueForModel(html, format: null);
        }

        public static MvcHtmlString ValueForModel(this FlexHtmlHelper html, string format)
        {
            return Value(html, String.Empty, format);
        }

        internal static MvcHtmlString ValueForHelper(FlexHtmlHelper html, string name, object value, string format, bool useViewData)
        {
